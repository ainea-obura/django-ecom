...
class MpesaAccessToken:
    ...
    valiadated_mpesa_access_token = mpesa_access_token['access_token']
...
def lipa_na_mpesa_online(request):
    access_token = MpesaAccessToken.valiadated_mpesa_access_token
    api_url = stk_push_url
    ...
    request = {
        ...
        "CallBackURL": "https://s"
                       "andbox.safaricom.co.ke/mpesa/",
        "AccountReference": "Grocer",
